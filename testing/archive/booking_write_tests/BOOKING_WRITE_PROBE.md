...
1. Push testing/app.py, testing/write_probe.py, tests/test_booking_write_probe.py
   og evt. denne vejledning og testing/archive/booking_write_tests/enable_booking_write_probe.sql.
2. Kør hele testing/archive/booking_write_tests/enable_booking_write_probe.sql i Supabase SQL Editor som
